const PostCard = () => {
    return(
            <div className="flex justify-center items-center p-6 m-6 bg-white border-t border-purple-600 rounded shadow-lg shadow-purple-800/50 lg:w-1/3 md:w-1/2 w-2/3 h-56 ">
                <form>
